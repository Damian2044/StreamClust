...
class ServicioClustering:
    ...
    def _validar_metodo_sesion(sesion, metodo_esperado: str) -> dict | None:
        if sesion.metodo != metodo_esperado:
            return {
                "success": False,
                "message": f"The session type is `{sesion.metodo}` and this endpoint requires `{metodo_esperado}`.",
                "data": {
    ...
    def agregar_punto_texto(
        ...
        *,
        ...
        if extractor_embeddings is None:
            return self._respuesta(
                False,
                "No embeddings extractor is available in the application.",
        ...
        if embedding is None:
            return self._respuesta(
                False,
                "Could not extract the text embedding.",
    ...
    def agregar_punto_imagen(
        ...
        *,
        ...
        if embedding is None:
            return self._respuesta(
                False,
                "Could not extract the image embedding.",
