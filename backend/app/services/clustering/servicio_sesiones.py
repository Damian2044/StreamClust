...
class SesionClustering:
    ...
    def procesar_vector(self, vector: np.ndarray, etiqueta_real: object = None) -> dict:
        ...
        return {
            ...
            "message": str(respuesta.get("message", "Point processed.")),
            "data": data,
        }
    ...
    def obtener_resumen(self) -> dict:
        ...
        return {
            "success": bool(respuesta.get("success", False)),
            "message": str(respuesta.get("message", "Summary generated.")),
            "data": data,
        }
...
class ServicioSesiones:
        ...
        *,
        ...
        if metodo_norm is None:
            return self._respuesta(
                False,
                "Invalid method. Use `datasets`, `imagenes`, or `texto`.",
        ...
        try:
            ...
            return self._respuesta(
                False,
                f"Error creating session: {error}",
    ...
    def obtener_resumen_sesion(self, sesion_id: str) -> dict:
        ...
        if sesion is None:
            return self._respuesta(False, "Session not found.", {"sesion_id": sesion_id})
    ...
    def eliminar_sesion(self, sesion_id: str) -> dict:
        ...
        self._sesiones.pop(sesion_id, None)
        return self._respuesta(True, "Session deleted.", {"sesion_id": sesion_id})
    ...
    def listar_sesiones(self) -> dict:
        ...
        return self._respuesta(True, "Sessions listed.", data)
