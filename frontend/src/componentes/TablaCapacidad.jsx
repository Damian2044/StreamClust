        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow mt-6 overflow-hidden">
            <div className="overflow-x-auto custom-scrollbar">
                <div className="min-w-[680px]">
                    {/* Header */}
                    <div className="grid grid-cols-[1.15fr_1fr_0.85fr_1.5fr] bg-gray-100 border-b text-sm font-semibold text-gray-600">
                    ...
                    <div className="max-h-[520px] overflow-y-auto custom-scrollbar">
                        {Object.entries(clusters).map(([nombre, datos]) => {
                            const porcentaje =
                                datos.capacidad > 0
                                    ? Math.min(datos.total / datos.capacidad, 1)
                                    : 0;

                            return (
                                <div
                                    key={nombre}
                                    className="grid grid-cols-[1.15fr_1fr_0.85fr_1.5fr] items-center border-b last:border-none text-sm"
                                >
                                    {/* Nombre */}
